...
class GameMap:
    ...
    def initialize_tiles(self):
        tiles = [[Tile(True) for y in range(self.height)] for 
    ...
    def make_map(self, max_rooms, room_min_size, room_max_size, map_width,
        ...
        for r in range(max_rooms):
            ...
            # run through the other rooms. See if they intersect with this one
    ...
    def place_entities(self, room, entities, max_monsters_per_room):
        ...
        for i in range(number_of_monsters):
            ...
            if not any([entity for entity in entities if 
